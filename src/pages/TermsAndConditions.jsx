    ...
    return (
        <div className="min-h-screen bg-white text-[#111111] py-24 px-6 md:px-12 lg:px-24">
            <div className="max-w-4xl mx-auto">
                ...
                >
                    <p className="text-xl font-serif mb-8 text-[#111111]">AGREEMENT TO OUR LEGAL TERMS</p>

                    <p className="mb-4">
                        We are Athams ('Company', 'we', 'us', or 'our'), a company registered in India at Maharashtra.
                    </p>
                    <p className="mb-4">
                        We operate the mobile application Eira (the 'App'), as well as any other related products and services that refer or link to these legal terms (the 'Legal Terms') (collectively, the 'Services').
                    </p>
                    <p className="mb-4">
                        You can contact us by email at <a href="mailto:care@meeteira.com" className="text-blue-600 hover:underline">care@meeteira.com</a> or by mail to Maharashtra, India.
                    </p>
                    <p className="mb-4">
                        These Legal Terms constitute a legally binding agreement made between you, whether personally or on behalf of an entity ('you'), and Athams, concerning your access to and use of the Services. You agree that by accessing the Services, you have read, understood, and agreed to be bound by all of these Legal Terms. IF YOU DO NOT AGREE WITH ALL OF THESE LEGAL TERMS, THEN YOU ARE EXPRESSLY PROHIBITED FROM USING THE SERVICES AND YOU MUST DISCONTINUE USE IMMEDIATELY.
                    </p>
                    <p className="mb-4">
                        We will provide you with prior notice of any scheduled changes to the Services you are using. The modified Legal Terms will become effective upon posting or notifying you by <a href="mailto:care@meeteira.com" className="text-blue-600 hover:underline">care@meeteira.com</a>, as stated in the email message. By continuing to use the Services after the effective date of any changes, you agree to be bound by the modified terms.
                    </p>
                    <p className="mb-4">
                    ...
                    <section className="mb-12">
                        <h2 className="text-2xl font-serif mb-6 text-[#111111]">TABLE OF CONTENTS</h2>
                        <ol className="list-decimal pl-6 space-y-1 font-medium grid md:grid-cols-2 gap-x-8">
                            <li>OUR SERVICES</li>
                            ...
                            <li>MISCELLANEOUS</li>
                            <li>AGE VERIFICATION AND RESPONSIBILITY</li>
                            <li>ACCEPTANCE OF TERMS</li>
                            <li>BETA STATUS AND NO MEDICAL ADVICE</li>
                            <li>CONTACT US</li>
                        </ol>
                    </section>

                    <section className="mb-12">
                        <h2 className="text-2xl font-serif mb-4 text-[#111111]">1. OUR SERVICES</h2>
                        <p>The information provided when using the Services is not intended for distribution to or use by any person or entity in any jurisdiction or country where such distribution or use would be contrary to law or regulation or which would subject us to any registration requirement within such jurisdiction or country. Accordingly, those persons who choose to access the Services from other locations do so on their own initiative and are solely responsible for compliance with local laws, if and to the extent local laws are applicable.</p>
                    </section>

                    <section className="mb-12">
                        <h2 className="text-2xl font-serif mb-4 text-[#111111]">2. INTELLECTUAL PROPERTY RIGHTS</h2>
                        ...
                        <p className="mb-4">Our Content and Marks are protected by copyright and trademark laws (and various other intellectual property rights and unfair competition laws) and treaties around the world.</p>
                        ...
                        <p className="mb-2">Subject to your compliance with these Legal Terms, including the 'PROHIBITED ACTIVITIES' section below, we grant you a non-exclusive, non-transferable, revocable licence to:</p>
                        ...
                        <p className="mb-4">If you wish to make any use of the Services, Content, or Marks other than as set out in this section or elsewhere in our Legal Terms, please address your request to: <a href="mailto:care@meeteira.com" className="text-blue-600 hover:underline">care@meeteira.com</a>. If we ever grant you the permission to post, reproduce, or publicly display any part of our Services or Content, you must identify us as the owners or licensors of the Services, Content, or Marks and ensure that any copyright or proprietary notice appears or is visible on posting, reproducing, or displaying our Content.</p>
                        ...
                        <p className="mb-2"><strong>You are responsible for what you post or upload:</strong> By sending us Submissions through any part of the Services you:</p>
                    ...
                    <section className="mb-12">
                        <h2 className="text-2xl font-serif mb-4 text-[#111111]">3. USER REPRESENTATIONS</h2>
                    ...
                    <section className="mb-12">
                        <h2 className="text-2xl font-serif mb-4 text-[#111111]">4. PURCHASES AND PAYMENT</h2>
                        <p className="mb-4">We accept the following forms of payment:</p>
                        <p className="mb-4">You agree to provide current, complete, and accurate purchase and account information for all purchases made via the Services. You further agree to promptly update account and payment information, including email address, payment method, and payment card expiration date, so that we can complete your transactions and contact you as needed. Sales tax will be added to the price of purchases as deemed required by us. We may change prices at any time. All payments shall be in  .</p>
                    ...
                    <section className="mb-12">
                        <h2 className="text-2xl font-serif mb-4 text-[#111111]">5. PROHIBITED ACTIVITIES</h2>
                        <p className="mb-4">You may not access or use the Services for any purpose other than that for which we make the Services available. The Services may not be used in connection with any commercial endeavours except those that are specifically endorsed or approved by us.</p>
                        ...
                        <ul className="list-disc pl-6 space-y-2">
                            ...
                            <li>Generating Fake Persona</li>
                        </ul>
                    </section>

                    <section className="mb-12">
                        <h2 className="text-2xl font-serif mb-4 text-[#111111]">6. USER GENERATED CONTRIBUTIONS</h2>
                    ...
                    <section className="mb-12">
                        <h2 className="text-2xl font-serif mb-4 text-[#111111]">7. CONTRIBUTION LICENCE</h2>
                    ...
                    <section className="mb-12">
                        <h2 className="text-2xl font-serif mb-4 text-[#111111]">8. GUIDELINES FOR REVIEWS</h2>
                    ...
                    <section className="mb-12">
                        <h2 className="text-2xl font-serif mb-4 text-[#111111]">9. MOBILE APPLICATION LICENCE</h2>
                        <h3 className="text-xl font-medium mb-2">Use Licence</h3>
                        ...
                        <h3 className="text-xl font-medium mb-2">Apple and Android Devices</h3>
                    ...
                    <section className="mb-12">
                        <h2 className="text-2xl font-serif mb-4 text-[#111111]">10. THIRD-PARTY WEBSITES AND CONTENT</h2>
                    ...
                    <section className="mb-12">
                        <h2 className="text-2xl font-serif mb-4 text-[#111111]">11. SERVICES MANAGEMENT</h2>
                    ...
                    <section className="mb-12">
                        <h2 className="text-2xl font-serif mb-4 text-[#111111]">12. PRIVACY POLICY</h2>
                        <p>We care about data privacy and security. Please review our Privacy Policy: <a href="https://www.meeteira.com/privacy-policy" className="text-blue-600 hover:underline">https://www.meeteira.com/privacy-policy</a>. By using the Services, you agree to be bound by our Privacy Policy, which is incorporated into these Legal Terms. Please be advised the Services are hosted in India, United States and Singapore. If you access the Services from any other region of the world with laws or other requirements governing personal data collection, use, or disclosure that differ from applicable laws in India, United States and Singapore, then through your continued use of the Services, you are transferring your data to India, United States and Singapore, and you expressly consent to have your data transferred to and processed in India, United States and Singapore.</p>
                    </section>

                    <section className="mb-12">
                        <h2 className="text-2xl font-serif mb-4 text-[#111111]">13. TERM AND TERMINATION</h2>
                    ...
                    <section className="mb-12">
                        <h2 className="text-2xl font-serif mb-4 text-[#111111]">14. MODIFICATIONS AND INTERRUPTIONS</h2>
                    ...
                    <section className="mb-12">
                        <h2 className="text-2xl font-serif mb-4 text-[#111111]">15. GOVERNING LAW</h2>
                        <p>These Legal Terms shall be governed by and defined following the laws of India. Athams and yourself irrevocably consent that the courts of India shall have exclusive jurisdiction to resolve any dispute which may arise in connection with these Legal Terms.</p>
                    </section>

                    <section className="mb-12">
                        <h2 className="text-2xl font-serif mb-4 text-[#111111]">16. DISPUTE RESOLUTION</h2>
                        ...
                        <p className="mb-4">Any dispute arising out of or in connection with these Legal Terms, including any question regarding its existence, validity, or termination, shall be referred to and finally resolved by the International Commercial Arbitration Court under the European Arbitration Chamber (Belgium, Brussels, Avenue Louise, 146) according to the Rules of this ICAC, which, as a result of referring to it, is considered as the part of this clause. The number of arbitrators shall be one (1). The seat, or legal place, or arbitration shall be India. The language of the proceedings shall be English. The governing law of these Legal Terms shall be substantive law of India.</p>
                    ...
                    <section className="mb-12">
                        <h2 className="text-2xl font-serif mb-4 text-[#111111]">17. CORRECTIONS</h2>
                        <p>There may be information on the Services that contains typographical errors, inaccuracies, or omissions, including descriptions, pricing, availability, and various other information. We reserve the right to correct any errors, inaccuracies, or omissions and to change or update the information on the Services at any time, without prior notice.</p>
                    </section>

                    <section className="mb-12">
                        <h2 className="text-2xl font-serif mb-4 text-[#111111]">18. DISCLAIMER</h2>
                    ...
                    <section className="mb-12">
                        <h2 className="text-2xl font-serif mb-4 text-[#111111]">19. LIMITATIONS OF LIABILITY</h2>
                    ...
                    <section className="mb-12">
                        <h2 className="text-2xl font-serif mb-4 text-[#111111]">20. INDEMNIFICATION</h2>
                    ...
                    <section className="mb-12">
                        <h2 className="text-2xl font-serif mb-4 text-[#111111]">21. USER DATA</h2>
                        <p>We will maintain certain data that you transmit to the Services for the purpose of managing the performance of the Services, as well as data relating to your use of the Services. Although we perform regular routine backups of data, you are solely responsible for all data that you transmit or that relates to any activity you have undertaken using the Services. You agree that we shall have no liability to you for any loss or corruption of any such data, and you hereby waive any right of action against us arising from any such loss or corruption of such data.</p>
                    </section>

                    <section className="mb-12">
                        <h2 className="text-2xl font-serif mb-4 text-[#111111]">22. ELECTRONIC COMMUNICATIONS, TRANSACTIONS, AND SIGNATURES</h2>
                    ...
                    <section className="mb-12">
                        <h2 className="text-2xl font-serif mb-4 text-[#111111]">23. MISCELLANEOUS</h2>
                    ...
                    <section className="mb-12">
                        <h2 className="text-2xl font-serif mb-4 text-[#111111]">24. AGE VERIFICATION AND RESPONSIBILITY</h2>
                        <p>We do not independently verify or validate the age of users. Age verification and eligibility checks are solely handled by the platform through which the user accesses our service (such as WhatsApp). If a user is under the age of 18, they must use the service only under the supervision and guidance of a parent or legal guardian. We are not responsible or liable for any use of the service by minors without appropriate parental consent or supervision, nor for any consequences arising from such use.</p>
                    </section>

                    <section className="mb-12">
                        <h2 className="text-2xl font-serif mb-4 text-[#111111]">25. ACCEPTANCE OF TERMS</h2>
                        <p>By accessing or using the service, including by sending any message or interacting with the chatbot, the user acknowledges that they have read, understood, and agree to be bound by these Terms and Conditions. Continued use of the service constitutes ongoing acceptance of these terms.</p>
                    </section>

                    <section className="mb-12">
                        <h2 className="text-2xl font-serif mb-4 text-[#111111]">26. BETA STATUS AND NO MEDICAL ADVICE</h2>
                        <p>The service is currently provided in beta and is powered by artificial intelligence. Responses may be inaccurate, incomplete, or contain errors. The service has not been clinically validated and is not intended to provide medical, psychological, or therapeutic advice, diagnosis, or treatment, nor to replace professional healthcare services. Users should not rely on the service as a substitute for medical or mental health care. We disclaim all responsibility and liability for any decisions, actions, or outcomes resulting from reliance on the service.</p>
                    </section>

                    <section className="mb-12">
                        <h2 className="text-2xl font-serif mb-4 text-[#111111]">27. CONTACT US</h2>
                        ...
                        <address className="not-italic mb-4">
                          ...
                          Maharashtra<br />
                            India<br />
                            <a href="mailto:care@meeteira.com" className="text-blue-600 hover:underline">care@meeteira.com</a>
                        </address>
                    </section>
